  ...
  return (
    <div className="music-player-signup-page">
      <style>{`
        ...
        .music-player-signup-page{--green:#ff0000;--green-hover:#ff3333;--bg:#121212;--bg-card:#181818;--bg-elevated:#282828;--bg-input:#242424;--border:#3e3e3e;--border-hover:#7a7a7a;--text-primary:#fff;--text-secondary:#b3b3b3;--text-muted:#727272;--font:'Nunito',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;height:100vh;width:100%;display:flex;flex-direction:column;background:var(--bg);font-family:var(--font);color:var(--text-primary);-webkit-font-smoothing:antialiased}
        .signup-header{flex-shrink:0;display:flex;align-items:center;justify-content:space-between;padding:0 48px;height:64px;border-bottom:1px solid var(--border);background:var(--bg)}
        ...
        .signup-card{background:var(--bg-card);border-radius:10px;border:1px solid var(--border);width:100%;max-width:480px;padding:24px 20px 32px;margin-bottom:24px;height:fit-content}
        ...
        .login-footer{border-top:1px solid var(--border);margin-top:24px;padding-top:20px;text-align:center}.login-footer p{font-size:13px;color:var(--text-secondary)}.login-footer a{color:var(--text-primary);font-weight:700;text-decoration:underline;transition:color .15s}.login-footer a:hover{color:var(--green)}
        .signup-footer-bar{flex-shrink:0;background:var(--bg);border-top:1px solid var(--border);padding:12px 48px;display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap}.signup-footer-bar p{font-size:11px;color:var(--text-muted);white-space:nowrap}
