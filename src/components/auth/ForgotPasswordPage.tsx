  ...
  return (
    <div className="music-player-login-page">
      <style>{` 
        ...
        .card{background:var(--bg-card);border:1px solid var(--border);border-radius:10px;width:90%;max-width:460px;padding:24px}
        ...
        input{width:100%;height:40px;padding:12px;border:1px solid var(--border);border-radius:8px;font-family:inherit;font-size:14px;color:var(--text-primary);background:#242424;outline:none}
