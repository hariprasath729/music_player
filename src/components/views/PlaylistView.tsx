...
export const PlaylistView: React.FC = () => {
  ...
  return (
    <div className="flex flex-col pb-4 select-none" onClick={closeMenu}>
      ...
      >
        <div className="h-48 w-48 shrink-0 rounded-md shadow-2xl sm:h-56 sm:w-56 overflow-hidden">
          <GlareHover
            width="100%"
            height="100%"
      ...
      <div className="flex flex-col px-2 sm:px-6">
        {activePlaylist.tracks.length === 0 ? (
          <div className="py-20 text-center text-[#b3b3b3]">
            <p className="text-lg font-bold text-white">This playlist is empty</p>
            <p className="mt-1 text-sm">Add some songs to get started!</p>
          </div>
        ) : (
