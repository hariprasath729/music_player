    ...
    <GoogleOAuthProvider clientId={GOOGLE_CLIENT_ID}>
      <div className="music-player-login-page">
        <style>{`
          ...
          .music-player-login-page{--green:#ff0000;--green-hover:#ff3333;--bg:#121212;--bg-card:#181818;--bg-elevated:#282828;--bg-input:rgba(0,0,0,0.25);--border:rgba(255,255,255,0.08);--border-hover:rgba(255,255,255,0.2);--text-primary:#fff;--text-secondary:#b3b3b3;--text-muted:#727272;height:100vh;width:100%;display:flex;flex-direction:column;overflow:hidden;background:transparent;pointer-events:none;font-family:Nunito,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:var(--text-primary);-webkit-font-smoothing:antialiased}
          .music-player-login-main{flex:1;display:flex;align-items:center;justify-content:center;overflow:hidden;padding:16px;min-height:0}.login-card{background:rgba(24, 24, 24, 0.45);backdrop-filter:blur(24px);border-radius:10px;border:1px solid rgba(255,255,255,0.08);box-shadow:0 8px 32px 0 rgba(0,0,0,0.37);pointer-events:auto;width:100%;max-width:460px;padding:clamp(20px,3.5vh,40px) clamp(20px,4vw,48px);overflow:hidden}.card-logo{display:flex;justify-content:center;margin-bottom:clamp(12px,2vh,22px)}.card-logo svg{width:clamp(34px,4vw,42px);height:clamp(34px,4vw,42px)}.login-card h1{font-size:clamp(1.25rem,2.5vw,1.85rem);font-weight:900;color:var(--text-primary);text-align:center;margin-bottom:clamp(14px,2.5vh,28px);letter-spacing:-.03em;line-height:1.2}
          .social-btn{display:flex;align-items:center;justify-content:center;gap:10px;width:100%;padding:clamp(9px,1.2vh,13px) 18px;border-radius:500px;font-family:inherit;font-size:clamp(12px,1.3vw,14px);font-weight:700;letter-spacing:.03em;cursor:pointer;text-decoration:none;border:1px solid rgba(255,255,255,0.08);background:rgba(255,255,255,0.02);color:var(--text-primary);margin-bottom:clamp(6px,1vh,10px);pointer-events:auto;transition:border-color .15s,background .15s,transform .1s}.social-btn:last-of-type{margin-bottom:0}.social-btn:hover{border-color:rgba(255,255,255,0.2);background:rgba(255,255,255,.06);transform:scale(1.01)}.social-btn svg{width:18px;height:18px;flex-shrink:0}.apple-icon{fill:#fff}.phone-icon{stroke:#fff;fill:none}.divider{display:flex;align-items:center;gap:12px;margin:clamp(10px,1.6vh,20px) 0}.divider hr{flex:1;border:none;border-top:1px solid var(--border)}.divider span{font-size:12px;font-weight:700;color:var(--text-muted);letter-spacing:.05em}
          .form-group{margin-bottom:clamp(10px,1.4vh,16px)}.form-group label{display:block;font-size:clamp(12px,1.2vw,13.5px);font-weight:800;color:var(--text-primary);margin-bottom:6px}.form-group input{width:100%;padding:clamp(9px,1.2vh,13px) 14px;border:1px solid var(--border);border-radius:5px;font-family:inherit;font-size:clamp(13px,1.3vw,15px);color:var(--text-primary);background:var(--bg-input);outline:none;transition:border-color .15s,box-shadow .15s}.form-group input:hover{border-color:var(--border-hover)}.form-group input:focus{border-color:rgba(255,255,255,0.4);box-shadow:0 0 0 3px rgba(255,255,255,.03)}.form-group input::placeholder{color:var(--text-muted)}.forgot-link{display:inline-block;font-size:clamp(12px,1.2vw,13.5px);font-weight:700;color:var(--text-primary);text-decoration:underline;margin-bottom:clamp(12px,1.8vh,22px);transition:color .15s}.forgot-link:hover{color:var(--green)}.btn-login{display:block;width:100%;padding:clamp(10px,1.4vh,15px);background:var(--green);color:#000;border:none;border-radius:500px;font-family:inherit;font-size:clamp(13px,1.3vw,15px);font-weight:800;letter-spacing:.06em;cursor:pointer;transition:background .15s,transform .1s}.btn-login:hover{background:var(--green-hover);transform:scale(1.02)}.captcha-note{font-size:clamp(9.5px,1vw,11px);color:var(--text-muted);text-align:center;margin-top:clamp(10px,1.4vh,16px);line-height:1.6}.captcha-note a{color:var(--text-muted);text-decoration:underline}.captcha-note a:hover{color:var(--text-secondary)}.signup-footer{border-top:1px solid rgba(255,255,255,0.08);margin-top:clamp(12px,1.8vh,24px);padding-top:clamp(12px,1.8vh,22px);text-align:center}.signup-footer p{font-size:clamp(13px,1.3vw,15px);color:var(--text-secondary)}.signup-footer a{color:var(--text-primary);font-weight:700;text-decoration:underline;transition:color .15s}.signup-footer a:hover{color:var(--green)}
      ...
      {/*
        ...
        {showContactModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 px-4 backdrop-blur-sm pointer-events-auto">
